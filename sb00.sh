...
install_singbox() {
echo -e "${yellow}本脚本同时两协议共存${purple}(hysteria2,tuic)${re}"
echo -e "${yellow}开始运行前，请确保在面板${purple}已开放2个udp端口${re}"
...
get_name() { if [ "$HOSTNAME" = "s1.ct8.pl" ]; then SERVER="CT8"; else SERVER=$(echo "$
